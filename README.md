...
8. Let the program do it's work.
   ...
   - It will check each image in that post for lack of resources. If it finds any lacking, it will click the Refresh button in the Resources card, thus populating that images resources.
